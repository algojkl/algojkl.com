export const kerhotoimintaData = {
  title: 'Kerhotoiminta',
  intro: `Kerhotoiminta on jäsenistön itsensä organisoimaa tekemistä, joka voi
  ...
  kerhot: [
    {
      name: 'Kyykkäkerho',
      description: `Kyykkäkerho tarjoaa mahdollisuuden tutustua kyykkään hauskassa ja

...
export const saannotSections = [
  ...
  },
  {
    ...
    content: (
      <>
        <p>Yhdistyksen tarkoituksena on toimia Jyväskylän yliopiston tieto- ja ohjelmistotekniikan ja teknologiajohtamisen opiskelijoiden yhdyssiteenä informaatioteknologian tiedekuntaan, edistää heidän opintojaan, harrastuksiaan ja yhteisiä etujaan sekä huolehtia jäsentensä oikeuksista opiskelijoina.</p>
        ...
        <ul>
          ...
          <li>voi järjestää kilpailuja, näytöksiä, retkiä, leirejä ja muita tapahtumia</li>
          <li>voi järjestää juhlia, konsertteja, näyttelyitä tai muita tilaisuuksia</li>
          ...
          <li>kokoaa jäsenet yhteiseen toimintaan ja ylläpitää yhteyksiä muihin alan yhdistyksiin</li>
          <li>ylläpitää jäsenistään koostuvaa esiintyvää ryhmää</li>
          <li>voi järjestää yhdistyksen tarkoitukseen liittyviä matkoja jäsenilleen</li>
          <li>voi osallistua jäsentensä välittömiin kilpailukustannuksiin</li>
          <li>voi hankkia tarvittavia aineistoja ja välineitä yhdistyksen käyttöön</li>
          <li>pyrkii järjestämään käyttöönsä tilat, joita yhdistyksen jäsenet voivat käyttää</li>
          <li>voi tehdä esityksiä ja aloitteita harrastusmahdollisuuksien lisäämiseksi</li>
          <li>toimii yhteistyössä viranomaisten, järjestöjen, yritysten ja yksityishenkilöiden kanssa</li>
        </ul>
        <h5>Toimintansa tukemiseksi yhdistys voi, hankittuaan tarvittaessa asianomaisen luvan:</h5>
        <ul>
            ...
            <li>harjoittaa anniskelutoimintaa järjestämiensä tilaisuuksien yhteydessä</li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
        Hallituksen jäsenen erotessa kesken toimikauden eronneen jäsenen tilalle voidaan valita uusi jäsen. Uuden jäsenen toimikausi kestää siihen asti kuin eronneen toimikausi olisi kestänyt.
        </p>
        <p>
        Kaikilla jäsenillä on oikeus osallistua hallituksen kokouksiin ilman äänivaltaa.
        </p>
      </>
    ),
  },
  {
    ...
    content: <><p>Yhdistyksen nimen kirjoittaa hallituksen puheenjohtaja, varapuheenjohtaja tai yritysvastaava kukin yksin.</p></>,
  },
  {
    title: "7. Tilikausi",
    content: <><p>Yhdistyksen tilikausi on kalenterivuosi. Tilinpäätös tarvittavine asiakirjoineen ja hallituksen vuosikertomus on annettava toiminnantarkastajalle viimeistään kolme viikkoa ennen kevätkokousta. Toiminnantarkastajan tulee antaa kirjallinen lausuntonsa viimeistään viikko ennen kevätkokousta hallitukselle.</p></>,
  },
  {
    title: "8. Yhdistyksen kokoukset",
    content: <><p>Yhdistys pitää vuosittain kaksi varsinaista kokousta. Yhdistyksen kevätkokous pidetään tammi-toukokuussa ja syyskokous syys-joulukuussa hallituksen määräämänä päivänä. Yhdistyksen kokouksissa jokaisella varsinaisella jäsenellä on yksi ääni. Kannattavalla jäsenellä ja kunniajäsenellä on kokouksessa läsnäolo- ja puheoikeus.</p>
    <p>
    Yhdistyksen kokouksen päätökseksi tulee, ellei säännöissä ole toisin määrätty, se mielipide, jota on kannattanut yli puolet annetuista äänistä. Äänten mennessä tasan ratkaisee kokouksen puheenjohtajan ääni, vaaleissa kuitenkin arpa. Kokous on päätösvaltainen, kun se on laillisesti koolle kutsuttu. Yhdistyksen kokoukseen voidaan osallistua hallituksen tai yhdistyksen kokouksen niin päättäessä myös postitse, tietoliikenneyhteyden tai muun teknisen apuvälineen avulla kokouksen aikana tai ennen kokousta.</p></>,
  },
  {
    ...
    content: <>
      ...
      ilmoittamaan osoitteeseen sekä jäsenille tarkoitetulla
      some-kanavalla.
      </p>
    </>
  },
  {
    ...
    <ul>
        <li>esitetään tilinpäätös ja toiminnantarkastajien/tilintarkastajien lausunto</li>
        ...
        <li>vahvistetaan liittymis- ja jäsenmaksujen suuruudet seuraavalle keräämiskaudelle (määritelty sääntöjen kohdassa 4. “Liittymis- ja jäsenmaksu”)</li>
    </ul>
    ...
    <ul>
        ...
        <li>valitaan yksi tai kaksi toiminnantarkastajaa ja varatoiminnantarkastajaa</li>
    </ul>

    <p>Mikäli yhdistyksen jäsen haluaa saada jonkin asian yhdistyksen kevät- tai syyskokouksen käsiteltäväksi, on hänen ilmoitettava siitä kirjallisesti hallitukselle niin hyvissä ajoin, että asia voidaan sisällyttää kokouskutsuun.</p>
    </>,
  },
  {
    title: "11. Sääntöjen muuttaminen ja yhdistyksen purkaminen",
    content: <>
    <p>Päätös sääntöjen muuttamisesta ja yhdistyksen purkamisesta on tehtävä yhdistyksen kokouksessa vähintään kolmen neljäsosan (3/4) enemmistöllä annetuista äänistä. Kokouskutsussa on mainittava sääntöjen muuttamisesta tai yhdistyksen purkamisesta. Yhdistyksen purkautuessa annetaan yhdistyksen varat kokouksen päättämään hyväntekeväisyyskohteeseen. Yhdistyksen tullessa lakkautetuksi käytetään sen varat samaan tarkoitukseen.</p></>,
  },
]

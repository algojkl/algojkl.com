  ...
  },
  {
    ...
    content: (
      <p>
        ...
        käsittelylle on rekisterinpitäjän oikeutettu etu (jäsenyys).
        Henkilötietojen käsittelyn tarkoitus on yhteydenpito jäseniin, sekä
        jäsenyyden tarkistaminen, silloin kun sitä vaaditaan (esim.
        Sääntömääräinen kokous). Tietoja ei käytetä automatisoituun
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        luottamuksellisesti ja vain niiden henkilöiden toimesta, joiden

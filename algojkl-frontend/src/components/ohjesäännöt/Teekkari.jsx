  ...
  return (
    <div>
      ...
      <p>
        ...
        <br />
        <br />
        Kaikki Jyväskylän yliopiston teekkariopiskelijat ovat oikeutettuja lakin
        ostoon riippumatta siitä, ovatko he Algo ry:n jäseniä vai eivät. Algo ry
        kuitenkin tilaa lakit ja voit ostaa sen kide.appin kautta, kun tilaus
        aukeaa. Tilauksen aukeamisesta tiedotetaan kaikille Jyväskylän
        ...
        päällys. Päällyksen keskeltä lähtee musta silkkitupsu. Lakin lippa sekä
        samettireunus ovat mustia ja sen hikinauha on joko nahkaa tai
        ...
        <br />
        <br />
        Teekkarilakin kantoaika on 30.4.–30.9. Teekkarilakin saa painaa päähänsä
        30.4. samaan aikaan, kun Minna Canthin patsas lakitetaan kello 18.00.
        Lakki lasketaan 30.9. kello 00.00. Muina aikoina teekkarilakkia ei saa
        kantaa ilman erillistä lakkilupaa, ellei pysyväisohjesääntö erikseen
        sitä salli. Lakkilupaa haetaan kirjallisesti Algo ry:n hallitukselta
        vähintään kolmea arkipäivää etukäteen. Hakemuksessa on käytävä selväksi,
        mihin tarkoitukseen lakkia aikoo käyttää. Lakkia saa käyttää vain
        lakkiluvassa määrättynä aikana ja siinä mainitussa tilaisuudessa.
        <br />
        <br />
        ...
        Teekkareiden kokoontuessa noustaan keskiyöllä korkeimmalle mahdolliselle
        kohdalle, nostetaan lakki käsi ojennettuna pään yläpuolelle ja lauletaan
        Teekkarihymni pimennetyssä tilassa, mikäli mahdollista. Lakin
        kantoaikana lakki lasketaan takaisin päähän teekkarihymnin jälkeen,
        mutta lakinlaskijaisissa se lasketaan olkapäälle.
        <br />
        <br />
        ...
        <br />
        8) Jyväskylän yliopiston ylioppilaskunnan (JYY) edustajiston kokouksissa
        <br />
        ...
        <br />
        <br />
        Teekkarilakkia ei kuulu korjata itse, ja jokaista reikää ja repsottavaa
        kohtaa vaalitaan merkkinä menneistä vuosista. Jos kuitenkin lakin kunto
        heikkenee liikaa, niin lakki kuuluu hävittää olemattomiin kaapinperälle
        ja hankkia uusi lakki tilalle. Jos teekkari osoittaa jatkuvaa
        piittaamattomuutta teekkarilakkia kohtaan, niin häntä voidaan rangaista
        teekkarikerhon päättämällä tavalla.
        <br />
        <br />
